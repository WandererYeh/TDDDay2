...
namespace PotterShoppingCart.Tests
{
    ...
    public class PotterShoppingCartTests
    {
        ...
        [TestMethod()]
        public void CountOrderSumTest_Buy_One_Book1_One_Book2_One_Book3_One_Book4_One_Book5_Should_Be_375() {
            var orders = new List<Order> {
                new Order { Name = "Book1", Price = 100, Qty = 1 },
                new Order { Name = "Book2", Price = 100, Qty = 1 },
                new Order { Name = "Book3", Price = 100, Qty = 1 },
                new Order { Name = "Book4", Price = 100, Qty = 1 },
                new Order { Name = "Book5", Price = 100, Qty = 1 }
            };
        ...
        [TestMethod()]
        public void CountOrderSumTest_Buy_One_Book1_One_Book2_Two_Book3_Should_Be_370() {
            var orders = new List<Order> {
                new Order { Name = "Book1", Price = 100, Qty = 1 },
                new Order { Name = "Book2", Price = 100, Qty = 1 },
                new Order { Name = "Book3", Price = 100, Qty = 1 },
        ...
        [TestMethod()]
        public void CountOrderSumTest_Buy_One_Book1_Two_Book2_Two_Book3_Should_Be_460() {
            var orders = new List<Order> {
                new Order { Name = "Book1", Price = 100, Qty = 1 },
                new Order { Name = "Book2", Price = 100, Qty = 1 },
                new Order { Name = "Book2", Price = 100, Qty = 1 },
